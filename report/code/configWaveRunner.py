...
# SETTINGS                                                                 #
# ------------------------------------------------------------------------ #
# The intrument's  IP address  can be checked  on the  oscilloscope itself.
...
class WaveRunner(object):
    ...
    def set_time_div(self,microseconds):
        self.__gen.write(
            self.__gen.channel + ':TIME_DIV ' + microseconds + 'US')

    def set_volt_div(self,millivolts):
        self.__gen.write(
            self.__gen.channel + ':VOLT_DIV ' + millivolts + 'MV')

    def set_offset(self,millivolts):
        self.__gen.write(
            self.__gen.channel + ':OFFSET ' + millivolts + 'MV')
